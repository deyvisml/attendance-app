...
export default function Lists() {
  ...
  async function createList() {
    try {
      ...
      setShowCreate(false);
      setFormName(getDefaultListName()); // resetea el nombre
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Pressable
            ...
            onPress={() =>
              router.navigate({
                pathname: "/attendance/[id]/registered",
